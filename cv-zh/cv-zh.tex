...
\section{教育背景}
\cventry{2009 -- 2013}{学士}{中国地质大学（武汉）}{通信工程}{机械与电子信息学院}{}  % 第3到第6编码可留白
\cventry{2013 -- 2015}{硕士}{中国地质大学（武汉）}{电子与通信工程}{机械与电子信息学院}{}
...
\cventry{2013.09 -- 2015.05}{SerDes接收端实现}{}{}{}{JESD204B是一种新的串行高速接口协议，专门用于高速模数转换芯片。单通道速率可达12.5Gbps。
主要使用Verilog语言设计、Modelsim仿真、Design Compiler综合，完成了接收端和发送端数据链路层的设计工作。%
\begin{itemize}%
\item 平台：Ubuntu + Vim
\item 工具：Verilog + Modelsim + Design Compiler 
\item 职责：
	\begin{itemize}
	\item 协议：JESD204B协议理解，掌握接口的工作流程、确定性时延实现方法、数据流处理方法等。
	\item 数据链路层：8B/10B解码器设计、解扰器设计、码群同步、frame同步、lane同步、差错控制。
	\item 确定性时延：本地Multiframe时钟对齐、缓冲器设计。
	\end{itemize}
\end{itemize}}
...
\item 职责：
	\begin{itemize}
	\item 信号：基于MSP430F149及FT232H构成采集卡，可以通过配置指令灵活的改变采样频率和数据长度。
	...
	\end{itemize}
\end{itemize}}
\cventry{2014.11 -- 2015.03}{中石化镇海炼化动态监控平台升级改造}{}{}{}{
取代原有的DSP架构，采用更灵活的ARM架构，采样节点也采用纯网络实现数据传输。%
\begin{itemize}%
\item 硬件平台：TM4C1294 + Raspberry Pi
\item 软件平台：Raspbian + CCS
\item 工具：C + Python + nc
\item 职责：
	\begin{itemize}
	\item 结构：TM4C1294作为采样节点通过网络上传数据，Raspberry Pi作为工作节点收集节点数据完成本地处理和上传服务器工作。
	\item 采样节点：需要实现峰值400KB/s的数据传输，最多需要监测12通道，每通道最高1.28K采样速率，以及辅助数据。
	\item 工作节点：利用网络收集采集到的数据进行具体的处理，主要是进行FFT变化，并将相关数据上传至中心服务器。
	\end{itemize}
\end{itemize}}
...
\subsection{编程}
\cvdoubleitem{C/C++}{\hfill 4年\qquad 熟练\bigquad}{Verilog}{\hfill 2年\qquad 熟练\bigquad}
\cvdoubleitem{Python}{\hfill 2年\qquad 一般\bigquad}{Bash}{\hfill 1年\qquad 一般\bigquad}
\subsection{工具}
\cvdoubleitem{Matlab}{\hfill 4年\qquad 熟练\bigquad}{Modelsim}{\hfill 2年\qquad 熟练\bigquad}
\cvdoubleitem{Git}{\hfill 2年\qquad 一般\bigquad}{Design Compiler}{\hfill 1年\qquad 一般\bigquad}
\cvdoubleitem{Word}{\hfill 5年\qquad 熟练\bigquad}{\LaTeX}{\hfill 2年\qquad 熟练\bigquad}
\cvdoubleitem{Vim}{\hfill 2年\qquad 一般\bigquad}{PLC}{\hfill 1年\qquad 熟练\bigquad}
\subsection{系统}
