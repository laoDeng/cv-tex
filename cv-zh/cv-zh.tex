...
\section{项目经验}
\cventry{2013.09 -- 2014.04}{SerDes接口实现}{}{}{}{SerDes接口是一种新的串行高速接口，常用于高端模数转换芯片。速率可达10Gbps。%
\begin{itemize}%
...
\item 嵌入式WinCE编程，主要包括串口控制PLC程序，USB控制采样卡。
\item 基于MATLAB GUI分析、SQL存储数据，将采集到的信号直接通过MATLAB做算法处理实验。
\end{itemize}}

\section{学习经验}
\cvitemwithcomment{数字信号处理}{}{熟悉数字滤波器设计，傅立叶变换；了解现代滤波技术；曾多次任该课程助教。}
\cvitemwithcomment{通信原理}{}{熟悉各种调制解调方法，经典编解码方法；了解MIMO技术，无线通信系统。}
\cvitemwithcomment{单片机}{}{熟悉单片机工作原理，汇编编程，驱动开发，曾用Verilog实现过简易单片机功能。}
\cvitemwithcomment{计算机网络}{}{熟悉分组交换原理，计算机网络组建，路由器、交换机配置；了解TCP/IP协议。}
