...
主要使用Verilog语言设计、Modelsim仿真、Design Compiler综合，完成了接收端解码接差错控制工作，并据此发表核心期刊论文%
\begin{itemize}%
\item 平台：Windows + CentOS + Sublime
\item 工具：Verilog + Modelsim + Design Compiler 
\item 职责：JESD204B协议理解及核心内容提炼，全面掌握接口的工作流程，包括硬件接口、成帧方式、编解码器、差错控制等。完成接收端的设计工作并做到180nm工艺标准下200MHz以上的工作速率，完成仿真及综合。
\end{itemize}}
\cventry{2010.01 -- 2013.06}{轴承振动检测系统}{}{}{}{
滚动轴承故障的自动检测系统整套流程设计。%
\begin{itemize}%
\item 信号：基于MSP430及FT232H构成采集卡，对信号进行FIR滤波、FFT变化、Hilbert-Huang变换等。
\item 算法：预处理后信号，基于大量数据，利用学习算法进行分类判决。
\item 实现：嵌入式Linux编程，主要包括串口控制PLC服务程序，USB采样卡服务程序，控制流程服务程序，UI程序。
\item 控制：PLC对机械部分控制，通过串口同上位机通信。
\end{itemize}}

\section{学习经验}
\cvitemwithcomment{数字信号处理}{}{熟悉数字滤波器设计，傅立叶变换，Hilbert-huang算法；了解现代滤波技术；多次任该课程助教。}
...
\cvitemwithcomment{数据结构与算法}{}{熟悉排序算法、链表、二叉树、图；了解机器学习算法，SVM，DBN。}

\section{计算机技能}
\cvdoubleitem{编程}{C, C++, ASM}{脚本}{Python, Bash}
\cvdoubleitem{硬件}{Verilog, PLC}{仿真}{Matlab, Modelsim, Design Compiler}
\cvdoubleitem{排版}{\LaTeX, Word, Markdown}{系统}{Windows, Ubuntu, CentOS}
\cvdoubleitem{版本}{Git}{数据库}{MySQL, SQL Server}
